...
<body>
                          ...
                          <?php if(auth()->guard()->guest()): ?>
                            <?php if(Route::has('login')): ?>
                                <li class="nav-item  navbar-item">
                                    <a class="nav-link " href="<?php echo e(route('login')); ?>"><?php echo e(__('Conexion')); ?></a>
                                </li>
                            <?php endif; ?>
                            <?php if(Route::has('register')): ?>
                                <li class="nav-item navbar-item">
  ...
  </script><?php /**PATH C:\xampp\htdocs\Nouveau_dossier\Projet-site-web\resources\views/header.blade.php ENDPATH**/ ?>